...
List<SuccessInfo> successInfo = [
  SuccessInfo(1,
      name: 'Yeon',
      iconImage: 'assets/images/yeon.jpg',
      description:
  ...
  SuccessInfo(2,
      name: 'Sung',
      iconImage: 'assets/images/sung.jpg',
      description:
  ...
  SuccessInfo(3,
      name: 'Jihyeon',
      iconImage: 'assets/images/hailey.jpg',
      description:
  ...
  SuccessInfo(4,
      name: 'Joon',
      iconImage: 'assets/images/joon.jpg',
      description:
  ...
  SuccessInfo(5,
      name: 'Virgil',
      iconImage: 'assets/images/virgil.jpeg',
      description:
  ...
  SuccessInfo(6,
      name: 'Salah',
      iconImage: 'assets/images/salah.jpg',
      description:
  ...
  SuccessInfo(7,
      name: 'Gerrard',
      iconImage: 'assets/images/gerrard.jpg',
      description:
  ...
  SuccessInfo(8,
      name: 'Klopp',
      iconImage: 'assets/images/klopp.jpg',
      description:
