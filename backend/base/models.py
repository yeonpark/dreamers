...
class MonthlyApplicationSchema(models.Model):
    ...
    parent = models.OneToOneField(
        ApplicationSchema, on_delete=models.CASCADE, related_name='schema_monthly')
...
class ScholarshipApplicationSchema(models.Model):
    ...
    parent = models.OneToOneField(
        ApplicationSchema, on_delete=models.CASCADE, related_name='schema_scholarship')
...
class Story(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE,
                             null=False, editable=False, related_name='story_user')
    category = models.ManyToManyField(
        ApplicationCategory, blank=True, related_name='story_category')
    social = models.OneToOneField(
        Social, on_delete=models.SET_NULL, null=True, related_name='social_features')
    ...
    schema = models.OneToOneField(
        ApplicationSchema, blank=False, on_delete=models.CASCADE, related_name="story_schema")
...
class StoryImage(models.Model):
    item = models.ForeignKey(
        Story, on_delete=models.CASCADE, related_name='item_image')
